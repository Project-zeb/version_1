...
> For an all-in-one dependency list see `full_requirements.txt` at the repository root.  Production deployments should follow the
> steps in `PRODUCTION_SETUP.md` and may use `setup_production.bat` on Windows.
