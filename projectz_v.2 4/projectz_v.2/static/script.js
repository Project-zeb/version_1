...
function createDisasterCard(disaster) {
    ...
    const icon = disaster.type === 'fire' ? '[FIRE]' : disaster.type === 'earthquake' ? '[EARTHQUAKE]' : '[LANDSLIDE]';
...
function renderAdminTab(tab) {
    ...
    reportsList.innerHTML = filteredReports.map(report => {
        const icon = report.type === 'fire' ? '[FIRE]' : report.type === 'earthquake' ? '[EARTHQUAKE]' : '[LANDSLIDE]';
