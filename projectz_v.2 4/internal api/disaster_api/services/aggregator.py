    ...
    for record in records:
        ...
        normalized.append(
            Alert(
                ...
                issued_at=_pick(
                    record, "issued_at", "issue_date", "observation_time", "timestamp", "date", "created_at"
                ),
                expires_at=_pick(record, "expires_at", "valid_till", "end_date"),
                headline=_pick(record, "headline", "title", "name"),
                description=_pick(record, "description", "summary", "details"),
                payload=record,
            )
        )
